...
def test_jumps():
    ...
    fig, tab = slj_test.results()
    slj_fig, slj_df = sdj_test.summary()
    ...
    fig, tab = cmj_test.results()
    cmj_fig, cmj_df = cmj_test.summary(
        {
            "Elevation": {
                "low": ((0, 10), "red"),
                "normal": ((10, 30), "yellow"),
            ...
            "Biceps femoris Imbalance (Concentric)": {
